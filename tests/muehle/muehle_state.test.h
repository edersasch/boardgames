...
{
public:
    MOCK_METHOD1(engine_future, void(std::future<void>&& efu));
...
void engine_future(::testing::StrictMock<Main_Loop_Mock>* ml, std::future<void>&& efu) { ml->engine_future(std::move(efu)); }
